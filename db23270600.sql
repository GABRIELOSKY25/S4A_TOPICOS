...
CREATE TABLE IF NOT EXISTS Articulo (
  ...
  INDEX Historial_Precio1_idx (idHistorial_Precio),
  INDEX Categoria1_idx (idCategoria),
  CONSTRAINT FK_Articulo_Historial
    FOREIGN KEY (idHistorial_Precio)
    REFERENCES Historial_Precio (idHistorial_Precio)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Restaurar configuraciones originales si no son NULL
